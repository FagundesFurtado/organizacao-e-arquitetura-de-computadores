 ...
 * @author Cris-
 */
public class Associativo extends javax.swing.JFrame {

    /**
     * Creates new form Associativo
     */
    public Associativo() {
        initComponents();
    ...
    public void SetElementos(int Blocos, int LinhasCache, int LinhasPrincipal, int ETAG, int TAG,int palavra, String resultado, String origem) {
        ...
        Object[] temp = {Blocos, LinhasCache, LinhasPrincipal, ETAG};
